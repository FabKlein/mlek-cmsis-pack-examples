...
#define RTE_CMSIS_Compiler_IO_STDOUT
#define RTE_CMSIS_Compiler_IO_STDOUT_User

#define RTE_CMSIS_Compiler_IO_STDERR
#define RTE_CMSIS_Compiler_IO_STDERR_User
